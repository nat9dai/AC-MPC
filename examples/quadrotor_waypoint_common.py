    ...
    *,
    ...
    for idx in range(num_envs):
        def _make(idx=idx):
            ...
            kwargs["env_id"] = idx
            adapter = QuadrotorStateObservationAdapter(**kwargs)
...
def prepare_config(
    ...
    *,
    ...
    actor_cfg.mpc.u_min = [0.0] + [-max_body_rate] * 3
    actor_cfg.mpc.u_max = [max_thrust] + [max_body_rate] * 3
    actor_cfg.mpc.u_ref = [mass * gravity, 0.0, 0.0, 0.0]

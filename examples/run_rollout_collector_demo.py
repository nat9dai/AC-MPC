#!/usr/bin/env python3
"""Rollout collector demo used by tests/examples/test_run_dummy_training.py."""
...
from ACMPC import ActorCriticAgent, RolloutCollector, load_experiment_config  # type: ignore  # noqa: E402
...
def main() -> None:
    ...
    # Collect a few short rollouts to ensure the pipeline works.
    for _ in range(max(args.steps, 1)):
        _ = collector.collect(horizon=base_cfg.sampler.rollout_steps)

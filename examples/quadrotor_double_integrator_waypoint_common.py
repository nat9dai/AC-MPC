"""Shared helpers for 3-D double-integrator waypoint training/evaluation scripts."""
...
from ACMPC.envs import DoubleIntegrator3DWaypointEnv
...
class StateObservationAdapter3D(gym.Env):
    """Expose only the 6-D physical state; 3-D waypoint goes into info."""

    metadata = {"render_modes": []}

    def __init__(self, **env_kwargs):
        super().__init__()
        self._base_env = DoubleIntegrator3DWaypointEnv(**env_kwargs)
    ...
    *,
    ...
    for idx in range(num_envs):
        def _make(idx=idx):
            ...
            kwargs["env_id"] = idx
            adapter = StateObservationAdapter3D(**kwargs)
